...
def main():
    ...
    parser.add_argument('--security',type=Path,default=ROOT/'parameter-security-b3.json')
    ...
    if args.security.exists():
        security.update({p['file']:p for p in json.loads(args.security.read_text())})
    screens={}
